                ...
                <div class="row g-4">
                    ...
                    <div class="col-6 col-md-4">
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item"><a class="nav-link" href="{{ route('blog') }}">News and Blogs</a></li>
                    ...
                    <div class="col-6 col-md-4">
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item"><a class="nav-link" href="{{ route('how-to-guide') }}">How to guide</a></li>
        ...
        <div class="py-3">
            <div class="container px-0">
                <div class="d-lg-flex justify-content-between align-items-center py-3 text-center text-md-left">
                    <!-- copyright text -->
                    <div class="text-body text-primary-hover">Copyrights ©{{ date('Y') }} Eduport. Build by <a href="https://www.webestica.com/" target="_blank" class="text-body">Webestica</a></div>
                    <!-- copyright links-->
                    <div class="justify-content-center mt-3 mt-lg-0">
                        <ul class="nav list-inline justify-content-center mb-0">
                            ...
                            <li class="list-inline-item"><a class="nav-link" href="{{ route('terms') }}">Terms of use</a></li>
                            <li class="list-inline-item"><a class="nav-link pe-0" href="{{ route('privacy') }}">Privacy policy</a></li>
                        </ul>
                    </div>
                </div>
            </div>
